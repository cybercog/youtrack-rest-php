# Contributing to YouTrack REST PHP
...
We are trying to keep backwards compatibility breaks in YouTrack REST PHP to an absolute minimum. Please take this into account when proposing changes.
